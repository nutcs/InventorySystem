...
namespace Inventory.Pages.Rangsit
{
    public class EditRangsitModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                String connectionString = "Server=tcp:inventory10messi.database.windows.net,1433;Initial Catalog=Iventorysystem;Persist Security Info=False;User ID=pawapob;Password=Ilovebarca10;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
        ...
        public void OnPost()
        {
            ...
            try
            {
                String connectionString = "Server=tcp:nutthapon.database.windows.net,1433;Initial Catalog=nutthapon;Persist Security Info=False;User ID=nutthapon;Password=Nn123456;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    connection.Open();
